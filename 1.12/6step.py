...
какой-то из случаев входных данных (число программистов 0≤n≤10000≤n≤1000). 
...
только русские символы для ответа. В остальных случаях ищите ошибку в логике работы 
программы.
'''
...
if 10 < int(numprogrammers) < 15:
    ...
    ans = 'программистов'
elif numprogrammers[lenght-1] == '1':
    ans ='программист'
elif 2 <= int(numprogrammers[lenght-1]) <= 4:
    ans ='программиста'

print(numprogrammers,ans)